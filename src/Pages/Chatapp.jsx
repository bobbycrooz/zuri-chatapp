    ...
    return (
        <MainApp>
            ...
            <Section>
                    ...
                    {
                        message?.map(msg => <Chatmessage message={msg}photoURL={photoURL} auth={auth} key={msg.id}/>)
                    }
              ...
              <Form className="form_container" onSubmit={sendMessage} >
                    <input value={formValue} onChange={(e) =>  setFormValue(e.target.value)} type="text" name="" id=""/>
